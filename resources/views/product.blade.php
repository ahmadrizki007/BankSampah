            ...
            <div class="flex items-center justify-center h-full bg-white bg-opacity-50">
                <div class="text-center text-black px-4 my-8">
                    <h2 class="text-3xl font-poppins mb-6">
                        Ingin Mendapatkan Informasi <span class="text-[#000000] font-bold">Produk</span> yang Lebih
                        Lengkap?
                    </h2>
                    <!-- Tombol dengan Background Hijau -->
                    <a href="#"
                        class="bg-[#276561] text-white py-3 px-10 rounded-lg text-xl font-poppins hover:bg-opacity-90">
                        Hubungi CS
                    </a>
                </div>
            </div>
