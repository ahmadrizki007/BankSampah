    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Formulir</h1>
            </div>
        </div>
                ...
                <table id="myTable" class="display min-w-full text-sm text-center">
                    <thead class="rounded-sm bg-gray-100 dark:bg-white/20 dark:text-white">
                        <tr>
                            ...
                            <th class="px-6 py-3">Tujuan Kunjungan</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white text-gray-700 dark:bg-gray-800 dark:text-white">
                        ...
                        @foreach ($data as $row)
                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-6 py-4"> {{ $row->instansi }} </td>
                                <td class="px-6 py-4">{{ $row->tujuan_kunjungan }}</td>
                            </tr>
                        @endforeach
