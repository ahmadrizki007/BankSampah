...
<header
    ...
    <div class="p-4 sm:px-6 lg:px-8 border-b-4 border-gray-200 dark:border-gray-700/60">
        <div
            class="flex items-center justify-between h-16 {{ $variant === 'v2' || $variant === 'v3' ? '' : ' dark:border-gray-700/60' }}">
